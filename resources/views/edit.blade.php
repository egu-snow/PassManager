...
@section('content')
    ...
    <form action="{{ route('acount.update',['id'=> $id])}}" method="POST">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" name="site_name" value="{{old('site_name',$site_name)}}" class="form-control" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">login ID</span>
            <input type="text" name="login_id" value="{{old('site_name',$login_id)}}" class="form-control" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">password</span>
            <input type="text" name="password" value="{{old('site_name',$password)}}" class="form-control" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Email</span>
            <input type="text" name="mail_address" value="{{old('site_name',$mail_address)}}" class="form-control" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">memo</span>
            <input type="text" name="memo" value="{{old('site_name',$memo)}}" class="form-control" aria-describedby="basic-addon1">
        </div>
        ...
        <div class="d-flex mb-5">
            <button type="submit" class="btn btn-outline-success me-3">保存する</button>
